    ...
    <section id="experience" className={styles.container}>
      ...
      <div className={styles.experience}>
        <WorkCard
          ...
          text="Приложение для разрешения споров и конфликтов на предприятии. Разработка в рамках мастерской Практикума. 
        ...
        <WorkCard
          ...
          text="Сайт интернет-магазина Твои ткани. Основные задачи, кроме создания пользовательской части приложения, является
